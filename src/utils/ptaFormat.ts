...
const DECIMAL_PTA_NAMES = [
  ...
  'CCR','HCR','FI','RFI','EFC','F SAV','PTAT','UDC','FLC','BWC','STA','STR','BD','DFM',
  'RUA','TW','RLS','RLR','FA','FUA','FLS','FTA','RUH','RUW','RW','UCL','UD','UDP','FTP',
  'RTP','FTL','SCE','DCE','SSB','DSB','GFI',
]

const INTEGER_PTA_NAMES = ['HHP$','TPI','NM$','CM$','FM$','GM$','PTAM','PTAF','CFP','PTAP']

const COLUMN_TO_LABEL: Record<string, string> = {
  hhp_dollar:'HHP$',tpi:'TPI',nm_dollar:'NM$',cm_dollar:'CM$',fm_dollar:'FM$',gm_dollar:'GM$',
  ...
  met:'Met',rp:'RP',ccr:'CCR',hcr:'HCR',fi:'FI',rfi:'RFI',f_sav:'F SAV',ptat:'PTAT',udc:'UDC',
