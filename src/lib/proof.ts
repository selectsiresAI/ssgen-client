...
export function buildProofFromFemale(f: FemaleFull): Proof {
  return {
    ped: [
    ...
    sections: [
      ...
      { t: 'Tipo', meta: '(PTA) · Predição Pedigree', rows: [['TPI', plus(n(f.tpi)), ''], ['PTAT', f2(n(f.ptat)), ''], ['UDC', f2(n(f.udc)), ''], ['FLC', n(f.flc).toFixed(2), '']] },
