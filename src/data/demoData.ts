...
export function buildProof(a: DemoAnimal) {
  const f2 = (v: number) => (v >= 0 ? '+' : '') + v.toFixed(2)
  const f1 = (v: number) => (v >= 0 ? '+' : '') + v.toFixed(1)
  return {
    ped: [
      ['role', 'Pai:', a.sireName + ' (' + a.sire + ')'],
      ['role', 'Avô Mat.:', a.mgsName + ' (' + a.mgs + ')'],
      ['role', 'Bisavô Mat.:', a.mggsName + ' (' + a.mggs + ')'],
    ],
    lin: [
      ['Estatura', Number(a.sta) || 0, 'T'],
      ['Força', Number(a.str) || 0, 'S'],
      ['Prof. Corporal', Number(a.dfm) || 0, 'D'],
      ['Largura de Garupa', Number(a.rw) || 0, 'W'],
      ['Ângulo de Garupa', Number(a.rua) || 0, 'S'],
      ['Pernas Tras. V. Lateral', Number(a.rls) || 0, 'S'],
      ['Pernas Tras. V. Trás', Number(a.rlr) || 0, 'H'],
      ['Ângulo do Casco', Number(a.fta) || 0, 'L'],
      ['Escore Pernas e Pés', Number(a.fls) || 0, 'L'],
      ['Úbere Anterior', Number(a.fua) || 0, 'S'],
      ['Altura Úbere Post.', Number(a.ruh) || 0, 'H'],
      ['Largura Úbere Post.', Number(a.ruw) || 0, 'W'],
      ['Ligamento Central', Number(a.ucl) || 0, 'W'],
      ['Prof. de Úbere', Number(a.udp) || 0, 'S'],
      ['Tetos Anteriores', Number(a.ftp) || 0, 'C'],
      ['Tetos Posteriores', Number(a.rtp) || 0, 'C'],
      ['Compr. de Tetos', Number(a.ftl) || 0, 'S'],
    ] as [string, number, string][],
    sections: [
      { t: 'Produção', meta: '(PTA) · 07/26 Predição Pedigree', rows: [['Leite', '+' + a.milk, ''], ['Proteína', '+' + a.prot, '% Prot ' + f2(a.prot_pct)], ['Gordura', '+' + a.fat, '% Gord ' + f2(a.fat_pct)], ['CFP', '+' + Number(a.cfp || 0), ''], ['NM$', '+$' + a.nm, ''], ['GM$', '+$' + a.gm, ''], ['F.Sav', '+' + Number(a.fsav || 0), ''], ['RFI', String(Number(a.rfi || 0)), '']] },
      { t: 'Tipo', meta: '(PTA) · 07/26 Predição Pedigree', rows: [['TPI', '+' + a.gtpi, ''], ['PTAT', f2(a.ptat), ''], ['UDC', f2(a.udc), ''], ['FLC', a.flc.toFixed(2), '']] },
      { t: 'Aptidão', meta: '', rows: [['HHP$\u00AE', '+$' + a.hhp, ''], ['SCS', a.scs.toFixed(2), ''], ['PL', f1(a.pl), ''], ['LIV', f1(a.liv), ''], ['DPR', f1(a.dpr), ''], ['HCR', f1(a.hcr), ''], ['CCR', f1(a.ccr), ''], ['FI', f1(Number(a.fi || 0)), '']] },
      { t: 'Saúde', meta: '', rows: [['Mastite', f1(Number(a.mast || 0)), ''], ['Metrite', f1(Number(a.met || 0)), ''], ['Ret. Placenta', f1(Number(a.rp || 0)), ''], ['Desp. Abomaso', f1(Number(a.da || 0)), ''], ['Cetose', f1(Number(a.ket || 0)), ''], ['Febre de Leite', f1(Number(a.mf || 0)), '']] },
      { t: 'Facilidade de Parto', meta: '', rows: [['SCE', a.sce.toFixed(1), ''], ['SSB', (Number(a.ssb || 0)).toFixed(1), ''], ['DSB', (Number(a.dsb || 0)).toFixed(1), ''], ['Gestação', f1(Number(a.gl || 0)), ''], ['EFC', '+' + Number(a.efc || 0), '']] },
    ],
  }
}
